...
namespace CCP.EveFrontier.SOF.SmartTurretSystem.Systems.SmartTurretSystem
{
    ...
    {
        public SmartTurretSystemServiceResource() : base("SmartTurret", "SmartTurretSystem") { }
    }
    public partial class SmartTurretSystemService: ISystemService<SmartTurretSystemServiceResource> 
    {
        ...
        public ISystemServiceResourceRegistration SystemServiceResourceRegistrator
        {
            get
            {
                return this.GetSystemServiceResourceRegistration<SmartTurretSystemServiceResource, SmartTurretSystemService>();
            }
        }
        ...
        {
            return new SmartTurretSystemDeployment().CalculateCreate2Address(deployerAddress, salt, byteCodeLibraries);
        }
        ...
        public Task<Create2ContractDeploymentTransactionResult> DeployCreate2ContractAsync(string deployerAddress, string salt, params ByteCodeLibrary[] byteCodeLibraries)
        {
            ...
            var deployment = new SmartTurretSystemDeployment();
